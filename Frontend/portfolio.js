...
pageContent['home'] += "Hello, i am Olusola Ayomide Victor, a passionate software engineer with a keen interest in crafting innovative solutions. <br>My journey in the world of technology has been driven by a desire to create seamless and efficient digital experiences. "
pageContent['home'] += "Specializing in backend and frontend development, i thrive on turning complex ideas into reality and ensuring the smooth functioning of applications.<br>With a solid foundation in Django for API's, i've had a priviledge of contributing to diverse projects,"
pageContent['home'] += "including a startup e-commerce platform called BabyDucts. My collaborative approach and commitment to excellence have been instrumental and delivering high-quality solutions"
...
pageContent['home'] += "<div id='content'>"
pageContent['home'] += "Welcome to my digital space. I'm Olusola Ayomide Victor, a software engineer on a mission to build technological solutions that make a meaningful impact."
...
pageContent['skill&education'] += "<li>Programming Languages <ul id='subList'> <li>Python</li>  <li>PHP</li> <li>JavaScript</li> <li>Css</li> </ul> </li>"
pageContent['skill&education'] += "<li>Framework <ul id='subList'> <li>Django</li> <li>Laravel</li> <li>ReactJs</li> <li>Tailwindcss</li> </ul> </li>"
...
pageContent['skill&education'] += "<li>Database Management <ul id='subList'> <li>MySQL</li> <li>PostgreSQL</li> <li>and other SQL Databases..</li> </ul> </li>"
...
pageContent['experience&project'] += "<li> Overview <ul id='subList'> <li>Babyducts is an ecommerce platform tailored for buying and selling baby products. The platform is designed to facilitate seamless transactions between sellers and buyers in the realm "
...
pageContent['experience&project'] += "  <li>3. Ensuring secure and efficient handling of transactions between sellers and buyers </li> </ul>"
pageContent['experience&project'] += "</li>"
pageContent['experience&project'] += "<li>Technology Used <ul id='subList'>"
pageContent['experience&project'] += "  <li>Background Worker (Celery)</li> <li>Redis (Message Broker)</li> <li>PostgreSQL</li> <li>SwaggerUI & RedocUI</li></ul> </li>"
pageContent['experience&project'] += "  <li>Status and Future Plans <ul id='subList'>"
pageContent['experience&project'] += "  <li>As of now, BabyDucts is in development stage. The team is actively working towards lauching. Stay tuned for updates on this exciting project.</li> </ul>"
pageContent['experience&project'] += "</li>"
pageContent['experience&project'] += "</ul>"
pageContent['experience&project'] += "</div>"

pageContent['experience&project'] += "<p id='topic'>HNG</p>"
pageContent['experience&project'] += "<div id='content'>"
pageContent['experience&project'] += "<ul id='mainList'>"
pageContent['experience&project'] += "<li> Overview <ul id='subList'> <li>Enrolled into HNG-11 internship for gaining hands-on experience with version control systems like Git and participated in team sprints and daily stand-ups."
pageContent['experience&project'] += "</li> </ul> </li>"
pageContent['experience&project'] += "<li>Role <ul id='subList'>"
pageContent['experience&project'] += "<li>As a key member of the development team, my responsibilities included:</li>"
pageContent['experience&project'] += "<li>1. Collaborated with senior developers on code reviews, learning best practices in software development and deployment, which provided a vast knowledge of message broker(redis, rabbitmq), gunicorn and nginx </li>"
pageContent['experience&project'] += "<li>2. Worked on real-world projects, including user authentication systems, payment processing integrations, and database management.</li>"
pageContent['experience&project'] += "<li>3. Contributed to multiple backend projects, developing and optimizing APIs using Django Rest Framework (DRF). </li> </ul> </li>"
pageContent['experience&project'] += "</ul>"
pageContent['experience&project'] += "</div>"
...
pageContent['blog'] += "<img src='images/Article1.jpg' id='article'>"
pageContent['blog'] += "<li>This blog teaches how to override Django default functionality. In many scenarios where Django default user model will not satisfy the project's requirement, the need to override the default behaviour will arise. This blog teaches the best approach to solve this problem. <br><a id='link' href='https://victorolusola.hashnode.dev/django-creating-custom-user-model' target='blank'>Read the full guide here.</a><br> Do ensure you subscribe to my newsletter. </li>"
pageContent['blog'] += "</ul>"
pageContent['blog'] += "</li>"
pageContent['blog'] += "<li>"
pageContent['blog'] += "2. Transitioning User Model"
pageContent['blog'] += "<ul id='subList'>"
pageContent['blog'] += "<img src='images/Article2.jpg' id='article'>"
pageContent['blog'] += "<li>This blog teaches how to apply Custom User model when database has been created. It is highly recommended to decide, whether to use Django default User model or override it before running the first/initial migration. The question now is \"what if the project's requirement require us to override the default user model in the middle of production?\". Perhaps more user details is now needed, how do you go about this?. This blog provides the solution with ease. <br> <a id='link' href='https://victorolusola.hashnode.dev/transitioning-user-model' target='blank'>Read the full guide here.</a> <br>Do ensure you subscribe to my newsletter. </li>"
pageContent['blog'] += "</ul>"
pageContent['blog'] += "</li>"
pageContent['blog'] += "<li>"
pageContent['blog'] += "3. Implementing Celery with Django using RabbitMQ"
pageContent['blog'] += "<ul id='subList'>"
pageContent['blog'] += "<img src='images/Article3.jpg' id='article'>"
pageContent['blog'] += "<li>"
pageContent['blog'] += "In this comprehensive guide, i walk you through configuring Celery, launching background workers, and integrating asynchronous tasks to supercharge your Django projects. Whether you're a seasoned developer or just diving into the world of Celery, this guide is your key to optimizing workflows, boosting performance, and mastering the art of efficient background task execution.<br>"
pageContent['blog'] += "<b>Key Insights:</b>"
pageContent['blog'] += "<ul id='subList'><li>Configuring Celery like a pro for your Django application.</li> <li>Launch background workers to handle asynchronous tasks effortlessly.</li> <li>Explore real-world scenarios showcasing the power of Celery in web development</li> <li>Enhance your development workflow with the magic of asynchronous process</li> </ul>"
pageContent['blog'] += "<a id='link' href='https://victorolusola.hashnode.dev/implementing-celery-with-django-using-rabbitmq'>Read the full guide here</a>"
