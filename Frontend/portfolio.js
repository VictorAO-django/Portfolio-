...
pageContent['home'] += "including a startup microservicebased e-commerce platform called BabyDucts. My collaborative approach and commitment to excellence have been instrumental and delivering high-quality solutions"
...
pageContent['home'] += "<br>Let's connect, collaborate, and bring innovative ideas to life."  
pageContent['home'] += "</div>"        
...
pageContent['blog'] += "<ul id='subList'> <li>This bog teaches how to apply Custom User model when database has been created. It is highly recommended to decide, whether to yse Django default user model or override it before running the first/initial migration. The question now is \"what if the project's requirement require us to override the default user model in the middle of production?\". Perhaps more user details is now needed, hod do you go about this?. This blog provides the solution with ease. Click on <a id='link' href='https://victorolusola.hashnode.dev/transitioning-user-model' target='blank'>link</a> to read. <br>Do ensure you subscribe to my newsletter. </li> </ul>"
pageContent['blog'] += "</li>"
pageContent['blog'] += "</ul>"
